...
type QueryResolver interface {
	Test(ctx context.Context, input *model.TestInput) (*model.TestOutput, error)
}
...
func (ec *executionContext) field_Query_test_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalOtestInput2ᚖgithubᚗcomᚋGokertᚋgnssᚑradarᚋinternalᚋpkgᚋmodelᚐTestInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_test(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.TestOutput)
	fc.Result = res
	return ec.marshalNtestOutput2ᚖgithubᚗcomᚋGokertᚋgnssᚑradarᚋinternalᚋpkgᚋmodelᚐTestOutput(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_test(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "test":
				return ec.fieldContext_testOutput_test(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type testOutput", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
