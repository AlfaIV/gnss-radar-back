...
func (a *App) Run(port string) error {
	...
	http.Handle("/hardware/spectrum", http.HandlerFunc(a.AddSpectrum))
	http.Handle("/hardware/power", http.HandlerFunc(a.AddPower))
...
func (a *App) AddSpectrum(w http.ResponseWriter, r *http.Request) {
	SendResponse(w, r, http.StatusOK, nil, "StatusOK", nil)
}
...
func SendResponse(w http.ResponseWriter, r *http.Request, status int, body any, errorMessage string, handlerError error) {
